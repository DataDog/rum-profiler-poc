...
export const Profile = {
    ...
    fromPartial(object: Partial<Profile>): Profile {
        ...
        if (
            object.durationNanos !== undefined &&
            object.durationNanos !== null
        ) {
...
export const Mapping = {
    ...
    fromPartial(object: Partial<Mapping>): Mapping {
        ...
        if (
            object.hasLineNumbers !== undefined &&
            object.hasLineNumbers !== null
        ) {
    ...
    encode(message: Line, writer: Writer = Writer.create()): Writer {
        ...
        if (
            ...
            (typeof message.line !== 'number' &&
                (message.line.low !== 0 || message.line.high !== 0))
        ) {
