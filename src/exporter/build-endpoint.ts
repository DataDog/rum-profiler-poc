...
export function buildEndpoint(
  ...
  const parameters = buildEndpointParameters(clientToken, configurationTags, transport)
...
function buildEndpointParameters(clientToken: string, configurationTags: string[], transport: 'beacon' | 'fetch') {
