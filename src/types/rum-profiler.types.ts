...
export interface RumMutationEntry {
...
export interface RumProfilerEnrichmentData {
  ...
  /** List of sampled mutation entries */
  readonly mutations: RumMutationEntry[];
}

export interface RumProfilerTrace
  extends ProfilerTrace,
    RumProfilerEnrichmentData {
...
export type RumProfilerSession =
  | RumProfilerStoppedSession
  | RumProfilerPausedSession
  | RumProfilerRunningSession;
